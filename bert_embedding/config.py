...
def get_config():
    ...
    parser.add_argument("--lr", type=float, default=5e-5, help="learning rate (default: 1e-5")
    ...
    parser.add_argument("--thres", type=float, default=0.5, help="threshold for obtaining prediction")
